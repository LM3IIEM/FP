...
SET REPO_DOWNLOAD_URL=https://github.com/kandi1clickkits/fakenews-detection/releases/download/v1.0.0/fakenews-detection-main.zip
SET REPO_DEPENDENCIES_URL=https://raw.githubusercontent.com/kandi1clickkits/fakenews-detection/main/requirements.txt
